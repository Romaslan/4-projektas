                ...
                <div class="card-body">
                    <form method="POST" action="{{route('profileimage.update', [$profileImage])}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image_alt" type="text" class="form-control" value='{{$profileImage->alt}}' name="image_alt"  required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image_width" type="number" min="0" max="200" step="10" value='{{$profileImage->width}}' class="form-control" name="image_width"  required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image_height" type="number" min="0" max="200" step="10" value='{{$profileImage->height}}' class="form-control" name="image_height"  required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image_class" type="text" class="form-control" name="image_class" value='{{$profileImage->class}}'  required autofocus>
                            </div>
                        </div>
